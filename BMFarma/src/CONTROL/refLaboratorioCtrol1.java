...
import FORMULARIOS.refLaboratorio1;
...
public class refLaboratorioCtrol1 {
   
private refLaboratorio1 laboratorio;           
...
String Editar="CALL Laboratorio_Upd(?,?)";      
    ...
    public refLaboratorioCtrol1(JDialog dialogoPadre){
      laboratorio = (refLaboratorio1) dialogoPadre;
