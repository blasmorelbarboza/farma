...
import CONTROL.refLaboratorioCtrol;
...
public class refLaboratorio extends javax.swing.JDialog {

    private refLaboratorioCtrol ctrlLaboratorio;
    
      int operacion=0;
      
    public refLaboratorio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        ctrlLaboratorio = new refLaboratorioCtrol(this);
                ...
                switch (operacion) {
                    case 1:
                            try {
                                    ...
                                    Logger.getLogger(refLaboratorio.class.getName()).log(Level.SEVERE, null, ex);
                                }
                    break;
                    case 2:
                            try {
...
//                ctrlLaboratorio.recupararDatos(ctrlLaboratorio.tablas.laboratorio, txtNacionalidad);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(refLaboratorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                refLaboratorio dialog = new refLaboratorio(new javax.swing.JFrame(), true);
